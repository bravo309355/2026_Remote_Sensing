...
def build_output_paths(output_dir=os.fspath(PROJECT_ROOT / "outputs"), timestamped=False, timestamp_token=None):
...
def run_pipeline(
    output_dir=os.fspath(PROJECT_ROOT / "outputs"),
    csv_only=False,
    map_only=False,
    timestamped_output=False,
    save_history=False,
    history_path=os.fspath(PROJECT_ROOT / "data" / "aqi_history.csv"),
    center_lat=None,
    center_lon=None,
